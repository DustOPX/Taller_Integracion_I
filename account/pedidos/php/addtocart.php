...
if(!empty($_POST)){
	if(isset($_POST["product_id"]) && isset($_POST["q"])){
        ...
        if(isset($_POST['button1'])) {
            print "<script>window.location.href='../bebidas.php';</script>";
        }
        if(isset($_POST['button2'])) {
            print "<script>window.location.href='../snacks.php';</script>";
        }
        if(isset($_POST['button3'])) {
            print "<script>window.location.href='../completos.php';</script>";
        }
        if(isset($_POST['button4'])) {
            print "<script>window.location.href='../cafes.php';</script>";
        }
        if(isset($_POST['button5'])) {
            print "<script>window.location.href='../sandwiches.php';</script>";
        }
        if(isset($_POST['button6'])) {
            print "<script>window.location.href='../wraps.php';</script>";
        }
