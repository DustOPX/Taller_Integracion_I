...
$products = $con->query("select * from productos where IDcategory = '2'");
?>
<table class="table table-bordered">
	...
	while($r=$products->fetch_object()):?>
		<tr>
			...
			<?php else:?>
			<form class="datos form-inline" method="post" action="./php/addtocart.php">
			<div class="inicio">
				...
				<input type="submit" class="btn btn-primary" name="button2" value="Añadir"/>
